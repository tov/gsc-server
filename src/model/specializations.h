...
template <> struct dbo_traits<Assignment> : public dbo_default_traits {
  using IdType = int;
...
template <> struct dbo_traits<User_stats> : public dbo_default_traits {
...
template <> struct dbo_traits<File_data> : public dbo_default_traits {
  using IdType = ptr<File_meta>;
  static IdType invalidId() { return IdType(); }
  static const char *surrogateIdField() { return nullptr; }
};

template <> struct sql_value_traits<Bytes, void> {
...
template <> struct sql_value_traits<File_purpose, void> {
...
template <> struct sql_value_traits<Time_stamp, void> {
