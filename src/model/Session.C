        ...
        : users_(*this)
{
    ...
    try {
        ...
        add(new Assignment(1, "Homework 1", 10,
                           now.addDays(-10), now.addDays(-3),
                           now.addDays(-1)));
        auto asst = add(new Assignment(2, "Homework 2", 10,
                                       now.addDays(-3),
                                       now.addDays(4),
                                       now.addDays(6)));
        add(new Assignment(3, "Homework 3", 10,
                           now.addDays(-8), now.addDays(-1),
                           now.addDays(1)));
        add(new Assignment(4, "Homework 4", 10,
        ...
        for (auto name : std::vector<std::string>{"student", "s1", "s2", "s3"}) {
            ...
            auto submission = add(new Submission(users_.find(student), asst));
