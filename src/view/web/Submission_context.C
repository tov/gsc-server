...
Submission_context_data::Submission_context_data(
        Submission_change_signal& change,
        Session& session,
...
Wt::Dbo::ptr<Assignment> assignment_of_submission(
        Wt::Dbo::ptr<Submission> const& submission)
{
...
Submission_context_root::Submission_context_root(
        ...
        Wt::Dbo::ptr<Submission> const& submission,
        Wt::Dbo::ptr<User> const& principal)
        : detail::Submission_context_root_data{}
        , Submission_context{real_changed_, session, submission, principal}
{ }
